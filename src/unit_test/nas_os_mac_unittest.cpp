...
TEST(nas_os_mac_test,add_entry) {
    ...
    cps_api_object_attr_add_u16(obj,BASE_MAC_TABLE_VLAN,vid);
    cps_api_object_attr_add(obj,BASE_MAC_TABLE_IFNAME,"e101-001-0", strlen ("e101-001-0")+1);
    ...
    cps_api_object_attr_add_u16(obj,BASE_MAC_TABLE_VLAN,vid);
    cps_api_object_attr_add(obj,BASE_MAC_TABLE_IFNAME,"e101-002-0", strlen ("e101-002-0")+1);
